    ...
    <main class="content">
        @if(isset($isAdmin) && $isAdmin)
            <div class="admin-header" style="margin-bottom: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px;">
                <h2 style="margin: 0; color: #333;">Обращения преподавателя: {{ $teacher->fio }}</h2>
        ...
        <div class="students-container">
            <div class="students-header">
                <h2>@if(isset($isAdmin) && $isAdmin)Обращения преподавателя{{ $teacher->fio }}@elseОбращения@endif</h2>
            </div>
            @if(session('success'))
